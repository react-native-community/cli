...
// No reference to lib.dom which was polluting node builtin types
// DOM-specific types were replaced with 'any'
...
declare module 'opentype.js' {
  ...
  export class Path {
    ...
    draw(ctx: any /* CanvasRenderingContext2D */): void;
    ...
    toDOMElement(decimalPlaces: number): any /* SVGPathElement */;
