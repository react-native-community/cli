 ...
 */
function validateAndUpgrade(argv: Array<string>, ctx: ContextT, args: FlagsT) {
  if (args.improved) {
    return newUpgrade.func(argv, ctx);
  }
  ...
  options: [
    {
      command: '--improved',
      description:
        'Improved implementation using rn-diff-purge project for diffing. This is going to be the default in next major and the old way of upgrading will be deprecated',
    },
  ],
};
